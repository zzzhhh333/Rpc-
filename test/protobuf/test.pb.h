...
class FriendListServiceRPC_Stub;

class FriendListServiceRPC : public ::PROTOBUF_NAMESPACE_ID::Service {
 protected:
  // This class should be treated as an abstract interface.
  inline FriendListServiceRPC() {};
 public:
  virtual ~FriendListServiceRPC();

  typedef FriendListServiceRPC_Stub Stub;
 ...
 private:
  GOOGLE_DISALLOW_EVIL_CONSTRUCTORS(FriendListServiceRPC);
};

class FriendListServiceRPC_Stub : public FriendListServiceRPC {
 public:
  FriendListServiceRPC_Stub(::PROTOBUF_NAMESPACE_ID::RpcChannel* channel);
  FriendListServiceRPC_Stub(::PROTOBUF_NAMESPACE_ID::RpcChannel* channel,
                   ::PROTOBUF_NAMESPACE_ID::Service::ChannelOwnership ownership);
  ~FriendListServiceRPC_Stub();

  inline ::PROTOBUF_NAMESPACE_ID::RpcChannel* channel() { return channel_; }

  // implements FriendListServiceRPC ------------------------------------------
 ...
 private:
  ::PROTOBUF_NAMESPACE_ID::RpcChannel* channel_;
  bool owns_channel_;
  GOOGLE_DISALLOW_EVIL_CONSTRUCTORS(FriendListServiceRPC_Stub);
};
...
// repeated .fixbug.User friend_list = 2;
inline int FriendListResponse::_internal_friend_list_size() const {
...
inline ::fixbug::User* FriendListResponse::mutable_friend_list(int index) {
  // @@protoc_insertion_point(field_mutable:fixbug.FriendListResponse.friend_list)
...
FriendListResponse::mutable_friend_list() {
  // @@protoc_insertion_point(field_mutable_list:fixbug.FriendListResponse.friend_list)
  return &_impl_.friend_list_;
}
inline const ::fixbug::User& FriendListResponse::_internal_friend_list(int index) const {
  return _impl_.friend_list_.Get(index);
}
inline const ::fixbug::User& FriendListResponse::friend_list(int index) const {
  // @@protoc_insertion_point(field_get:fixbug.FriendListResponse.friend_list)
  return _internal_friend_list(index);
}
inline ::fixbug::User* FriendListResponse::_internal_add_friend_list() {
  return _impl_.friend_list_.Add();
}
inline ::fixbug::User* FriendListResponse::add_friend_list() {
  ::fixbug::User* _add = _internal_add_friend_list();
  // @@protoc_insertion_point(field_add:fixbug.FriendListResponse.friend_list)
  return _add;
}
inline const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::fixbug::User >&
FriendListResponse::friend_list() const {
  // @@protoc_insertion_point(field_list:fixbug.FriendListResponse.friend_list)
  return _impl_.friend_list_;
}
